...
class CatalogRepository:
    ...
    @staticmethod
    def _public_statement(now: datetime | None = None) -> Select[tuple[Deal]]:
    ...
    def list_public_deals(
        ...
        *,
        ...
        statement = self._public_statement()
        if category:
        ...
        statement = statement.order_by(Deal.featured.desc(), Deal.verified_at.desc()).offset(offset).limit(limit)
    ...
    def count_public_deals(
        ...
        *,
        ...
        statement = self._public_statement().with_only_columns(Deal.id).order_by(None)
        if category:
            statement = statement.where(Product.category == category)
        elif categories:
            statement = statement.where(Product.category.in_(categories))
